...
class SetupConfiguration:
    ...
    def setupInstall(self):
        ...
        setup(name='NONLINEAR_MODELS',
            ...
            license='Open GPL 3',
            packages=['modulesNLM', 'modulesNLM.clustering_analysis', 'modulesNLM.checks_module', 'modulesNLM.supervised_learning_analysis', 'modulesNLM.supervised_learning_predicction', 'modulesNLM.utils', 'modulesNLM.graphic'],)
